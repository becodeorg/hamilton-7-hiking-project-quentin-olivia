<nav class="relative w-full flex flex-wrap items-center justify-between py-3 bg-gray-100 text-gray-200 shadow-lg navbar navbar-expand-lg navbar-light">
    <ul class="navbar-nav flex flex-row pl-0 list-style-none mr-auto">
        <li class="nav-item p-2"><a class="text-xl text-black font-semibold" href="/">HIKES</a></li>
